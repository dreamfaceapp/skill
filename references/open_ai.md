...
Generate high-quality images from text prompts using OpenAI's gpt-image-2 model. Supports image-to-image editing via reference images, batch generation (up to 10), and flexible aspect ratios with resolutions up to 3840×3840.
