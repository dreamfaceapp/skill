...
An AI agent skill that gives you access to 32 AI-powered tools for video generation, talking avatars, image editing, voice cloning, and more — all by simply describing what you want in natural language.
...
| "Try this shirt on a model" | A virtual try-on result image |
...
| Image Editing (7) | Colorize, Enhance, Outpainting, Inpainting, Swap Face, Remove BG, Virtual Try-On | `scripts/image_edit.py` |
...
| ByteDance (3) | Seedance 2.0, Seedance 2.0 Mini, Seedream (4.0/4.5/5.0 Lite/5.0 Pro) | `scripts/byte_dance.py` |
